...
namespace UselessChecker
{
    public partial class Form1 : Form
    {
        ...
        private async Task ShowIntroScreenAsync()
        {
            ...
            panel.Controls.Add(new Label { Text = "Система диагностики и анализа процессов | Версия 3.0.8", Font = new Font("Segoe UI", 9, FontStyle.Regular), ForeColor = CyberPalette.TextSecondary, Size = new Size(500, 25), Location = new Point(50, 142), TextAlign = ContentAlignment.MiddleCenter, BackColor = Color.Transparent });
